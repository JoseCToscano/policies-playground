    ...
    <div className="fixed w-full z-50 px-4 sm:px-6 lg:px-8 pt-6">
      <nav
        className={`max-w-7xl mx-auto rounded-full transition-all duration-500 ${
          isScrolled
            ? 'opacity-95 bg-[#0a0a0a]/90 backdrop-blur-sm shadow-lg border border-gray-800'
            : 'bg-[#0a0a0a]/80 backdrop-blur-sm border border-gray-800'
        } text-gray-100`}
      >
          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="font-bold text-white hidden sm:block text-lg">
                  Stellar AI Agent Kit
                </span>
              </Link>
                ...
                <div className="flex items-center space-x-8">
                  <div className="relative group">
                    <button
                      aria-haspopup="true"
                      aria-expanded="false"
                      className="text-gray-300 hover:text-white flex items-center space-x-1 text-sm transition-colors duration-300"
                    >
                      <span>Features</span>
                      <ChevronDown className="h-4 w-4 transform group-hover:rotate-180 transition-transform duration-300" />
                    </button>
                    <div className="absolute left-0 mt-2 w-56 bg-[#0a0a0a] text-gray-300 rounded-lg shadow-lg py-2 z-20 invisible group-hover:visible transition-all duration-300 opacity-0 group-hover:opacity-100 border border-gray-700">
                      <Link
                        href="#mcp-generator"
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden mt-4 bg-[#0a0a0a]/95 backdrop-blur-sm rounded-2xl transition-all duration-300 transform border border-gray-800 ${
          isOpen
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link
            href="#mcp-generator"
            className="text-gray-300 hover:text-white block px-3 py-2 text-base transition-colors duration-300"
