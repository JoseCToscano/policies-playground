    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="flex justify-between items-center px-8 py-6">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-gray-900">Smart Wallets Playground</span>
        </div>
        <div className="flex items-center space-x-6">
          <a href="/home" className="text-gray-600 hover:text-gray-900">Test it out</a>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="/home"
                  className="flex items-center justify-center space-x-2 text-gray-900 border border-gray-300 px-6 py-3 rounded-lg font-medium hover:bg-gray-50 transition duration-300 bg-gray-900 text-white">
                  <span>Create a Smart Wallet</span>
                </a>
              </div>
            </div>
