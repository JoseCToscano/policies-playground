      ...
      <main className="pt-20">
        <Section className="relative flex flex-col items-center justify-center min-h-[80vh] text-center space-y-6 overflow-hidden">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
            A CLI toolkit and signer infrastructure for safely integrating
            Stellar into AI-native workflows.
          </p>
        ...
        <Section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            <div className="p-px rounded-xl bg-gradient-to-br from-purple-700 via-pink-600 to-amber-500">
              <div className="bg-[#080808] rounded-xl p-6 h-full">
                ...
                <p className="text-sm text-gray-400">
                  Convert Soroban contracts into MCP-compliant servers
                  (TypeScript &amp; Python).
                </p>
              </div>
            </div>
            <div className="p-px rounded-xl bg-gradient-to-br from-purple-700 via-pink-600 to-amber-500">
              <div className="bg-[#080808] rounded-xl p-6 h-full">
                <h3 className="text-lg font-medium mb-2">
                  Policy Signer Generator
                </h3>
                <p className="text-sm text-gray-400">
                  Guide developers to build scoped signer rules for agent-safe
                  execution.
                </p>
              </div>
            </div>
            <div className="p-px rounded-xl bg-gradient-to-br from-purple-700 via-pink-600 to-amber-500">
              <div className="bg-[#080808] rounded-xl p-6 h-full">
                <h3 className="text-lg font-medium mb-2">
                  Policy Sandbox Web App
                </h3>
                <p className="text-sm text-gray-400">
                  Test policy signer logic before giving AI agents wallet
                  access.
                </p>
              </div>
            </div>
            <div className="p-px rounded-xl bg-gradient-to-br from-purple-700 via-pink-600 to-amber-500">
              <div className="bg-[#080808] rounded-xl p-6 h-full">
                ...
                <p className="text-sm text-gray-400">
                  Build AI-native apps with safe transaction flows using
                  Stellar’s policy model.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex items-center justify-center">
              <div className="w-full h-64 bg-gray-800 rounded-lg flex items-center justify-center">
                <Image
                  src="/placeholder.svg"
                  alt="Execution Flow: Agent → MCP → Policy Signer → Stellar"
                  width={400}
                  height={250}
